    ...
    <section className="selected-works">
      <div className="selected-works_container">
        ...
        <div className="one-work">
          <h3>Tagger</h3>
          <h4>
            Championing product-led growth for the world's largest influencer
            marketing platform, trusted by renowned brands such as Amazon,
            Intel, Porsche, and Bose.
          </h4>
          <table>
            <tbody>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <ul>
                    ...
                    <li>Product-led Growth Advocacy</li>
        ...
        <div className="one-work">
          <h3>Theatre.js</h3>
          <h4>
            Crafting an MVP and forging a Product-Led Growth vision for the
            world's pioneering visual animation library tailored specifically
            for web browsers.
          </h4>
          <table>
            <tbody>
        ...
        <div className="one-work">
          <h3>Setmore</h3>
          <h4>
            Laying the groundwork to expand the business model of the global
            scheduling platform.
          </h4>
          <table>
            <tbody>
